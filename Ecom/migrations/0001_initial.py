        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Enter the category name (e.g. Fashion)",
                        max_length=80,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Enter the product name (e.g. Phone)", max_length=80
                    ),
                ),
                ("description", models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Enter a User name (e.g. John Doe)", max_length=100
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Enter the subcategory name (e.g. man clothes)",
                        max_length=80,
                    ),
                ),
                ("description", models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "buyer_ID",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.RESTRICT, to="Ecom.user"
                    ),
                ),
                (
                    "product_ID",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.RESTRICT, to="Ecom.product"
                    ),
                ),
            ],
        ),
