...
class Users(models.Model):
    ...
    name = models.CharField(
        max_length=60, help_text='Enter a User name (e.g. John Doe)')
...
class Book(models.Model):
    ...
    language = models.ForeignKey('Language', on_delete=models.SET_NULL,
                                 null=True, help_text='Select a language for this book')
...
class Language(models.Model):
    ...
    name = models.CharField(
        max_length=200, help_text='Enter the language of the book (e.g. English)')
